...
ActiveRecord::Schema[7.0].define(version: 2021_08_22_083311) do
  create_table "challenge_payments", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "user_id"
  ...
  create_table "match_questions", charset: "utf8mb4", force: :cascade do |t|
    t.integer "match_id"
  ...
  create_table "matches", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.datetime "match_date", precision: nil
    t.integer "round_id"
  ...
  create_table "predictions", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "stadia", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "tournament_types", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.string "game"
